...
import in.co.swastikbhattacharyya.projects.desiwanderer.comment.service.CommentReportCreateService;
import in.co.swastikbhattacharyya.projects.desiwanderer.comment.service.CommentReportDeleteService;
import in.co.swastikbhattacharyya.projects.desiwanderer.comment.service.CommentReportUpdateService;
...
public class CommentReportKafkaConsumer {
  ...
  private final CommentReportUpdateService commentReportUpdateService;
  private final CommentReportDeleteService commentReportDeleteService;
  ...
  public void listen(
    ...
    switch (value.operation()) {
      case READ, CREATE -> this.commentReportCreateService.create(value);
      case UPDATE -> this.commentReportUpdateService.update(key.id(), value);
      case DELETE -> this.commentReportDeleteService.deleteById(key.id());
      case TRUNCATE -> this.commentReportDeleteService.deleteAll();
    }
