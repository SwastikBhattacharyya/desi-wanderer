...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    h1: "scroll-m-20 py-2 text-4xl font-extrabold tracking-tight lg:text-5xl",
    h2: "scroll-m-20 py-2 text-3xl font-semibold tracking-tight first:mt-0",
    h3: "scroll-m-20 py-2 text-2xl font-semibold tracking-tight",
